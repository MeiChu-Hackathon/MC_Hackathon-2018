<template>
    <div id="sponsor">
        ...
        <div class="planet">
            <img src="../assets/yellow_planet.svg">
        </div>
        <div class="intro container">
            <div class="row justify-content-end">
                <div class="content col-md-5">
                    ...
                    <div class="part">
                        <h3>企業介紹</h3>
                        <p>Logitech International S.A. 羅技電子是一家著重創新與品質的瑞士公司，
                            其個人週邊產品的設計為消費者提供絕佳的數位體驗。我們從 1981 年開始
                            研發當時所沒有的滑鼠，讓使用者可以用更直覺的方式與個人電腦互動。
                        </p>
                        <p>
                        從成立到現在，我們將專業知識擴展到電腦滑鼠以外的產品設計，以多種介面
                    ...
                    <div class="part">
                        ...
                        <p>3) Use the craft <a href="https://github.com/Logitech/logi_craft_sdk">SDK</a> to provide meaningful experience in gaming</p>
